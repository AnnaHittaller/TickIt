...
function updateCounters() {
	...
	let completedTasks = document.getElementById(
	...
	let allTasks =
		document.getElementById("completed-tasks-list").childElementCount +
	...
	document.querySelector(".star-marked").innerHTML =
		filteredImportantTasks.length;
}

window.addEventListener("click", updateCounters);
window.addEventListener("load", updateCounters);
window.addEventListener("keydown", updateCounters);
